...
void transTypeInference()
{
    ...
    actorInfo->outports[0]->arraySize.clear();
}
...
string transExecExpression()
{
	...
	if(actorInfo->inports.size() == 2) {
        ...
        expressionStr += getCGTActorExeTransSourceOutportVariableNameByName(inport1->sourceOutport);
        expressionStr += " * ";
        expressionStr += getCGTActorExeTransSourceOutportVariableNameByName(inport2->sourceOutport);
        expressionStr += ";";
...
vector<StmtBatchCalculation> transExecBatchCalculation()
{
    ...
    if(actorInfo->inports.size() != 2 || 
        ...
        actorInfo->inports[1]->arraySize.empty())
        return ret;
    CGTActorExeTransOutport* outport = actorInfo->outports[0];
    StmtBatchCalculation stmt;
    stmt.operationType = StmtBatchCalculation::TypeDotMul;
