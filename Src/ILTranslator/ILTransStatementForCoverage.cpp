...
int ILTransStatementForCoverage::translateStmtIf(const Statement* stmt)
{
...
int ILTransStatementForCoverage::translateStmtElse(const Statement* stmt)
{
...
int ILTransStatementForCoverage::translateStmtElseIf(const Statement* stmt)
{
...
int ILTransStatementForCoverage::translateStmtWhile(const Statement* stmt)
{
...
int ILTransStatementForCoverage::translateStmtDoWhile(const Statement* stmt)
{
...
int ILTransStatementForCoverage::translateStmtFor(const Statement* stmt)
{
...
int ILTransStatementForCoverage::translateStmtContinue(const Statement* stmt)
{
	statementStr += "continue;\n";
	return 1;
}

int ILTransStatementForCoverage::translateStmtSwitch(const Statement* stmt)
{
...
int ILTransStatementForCoverage::translateStmtCase(const Statement* stmt)
{
...
int ILTransStatementForCoverage::translateStmtDefault(const Statement* stmt)
{
