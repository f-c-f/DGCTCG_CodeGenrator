...
int ILTransStatementForLibFuzzer::translateStmtIf(const Statement* stmt)
{
...
int ILTransStatementForLibFuzzer::translateStmtElse(const Statement* stmt)
{
...
int ILTransStatementForLibFuzzer::translateStmtElseIf(const Statement* stmt)
{
...
int ILTransStatementForLibFuzzer::translateStmtWhile(const Statement* stmt)
{
...
int ILTransStatementForLibFuzzer::translateStmtDoWhile(const Statement* stmt)
{
...
int ILTransStatementForLibFuzzer::translateStmtFor(const Statement* stmt)
{
...
int ILTransStatementForLibFuzzer::translateStmtContinue(const Statement* stmt)
{
	statementStr += "continue;\n";
	return 1;
}

int ILTransStatementForLibFuzzer::translateStmtSwitch(const Statement* stmt)
{
...
int ILTransStatementForLibFuzzer::translateStmtCase(const Statement* stmt)
{
...
int ILTransStatementForLibFuzzer::translateStmtDefault(const Statement* stmt)
{
