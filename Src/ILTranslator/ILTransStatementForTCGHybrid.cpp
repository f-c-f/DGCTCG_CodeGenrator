...
int ILTransStatementForTCGHybrid::translateStmtIf(const Statement* stmt)
{
...
int ILTransStatementForTCGHybrid::translateStmtElse(const Statement* stmt)
{
...
int ILTransStatementForTCGHybrid::translateStmtElseIf(const Statement* stmt)
{
...
int ILTransStatementForTCGHybrid::translateStmtWhile(const Statement* stmt)
{
...
int ILTransStatementForTCGHybrid::translateStmtDoWhile(const Statement* stmt)
{
...
int ILTransStatementForTCGHybrid::translateStmtFor(const Statement* stmt)
{
...
int ILTransStatementForTCGHybrid::translateStmtContinue(const Statement* stmt)
{
	statementStr += "continue;\n";
	return 1;
}

int ILTransStatementForTCGHybrid::translateStmtSwitch(const Statement* stmt)
{
...
int ILTransStatementForTCGHybrid::translateStmtCase(const Statement* stmt)
{
...
int ILTransStatementForTCGHybrid::translateStmtDefault(const Statement* stmt)
{
